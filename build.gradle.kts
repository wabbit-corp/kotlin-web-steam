...
kover {
    ...
    //             // title.set("kotlin-web-steam Code Coverage") // Uncomment to customize title
    //         }
    //         xml {
...
dokka {
    ...
    dokkaSourceSets.main {
        ...
        sourceLink {
            ...
            remoteUrl("https://github.com/wabbit-corp/kotlin-web-steam/tree/master/src/main/kotlin")
